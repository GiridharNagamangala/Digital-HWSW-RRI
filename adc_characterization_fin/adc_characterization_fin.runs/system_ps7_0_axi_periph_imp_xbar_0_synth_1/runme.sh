...
HD_PWD='D:/Vivado+Vitis/redpitaya_guide/tmp/5_averager/5_averager.runs/system_ps7_0_axi_periph_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ps7_0_axi_periph_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ps7_0_axi_periph_imp_xbar_0.tcl
