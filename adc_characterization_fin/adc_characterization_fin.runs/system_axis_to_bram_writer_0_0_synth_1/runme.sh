...
HD_PWD='D:/Vivado+Vitis_Projects/adc_characterization_fin/adc_characterization_fin.runs/system_axis_to_bram_writer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axis_to_bram_writer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axis_to_bram_writer_0_0.tcl
