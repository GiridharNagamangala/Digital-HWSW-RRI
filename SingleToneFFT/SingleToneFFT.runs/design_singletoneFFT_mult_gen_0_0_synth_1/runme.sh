...
EAStep vivado -log design_singletoneFFT_mult_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_singletoneFFT_mult_gen_0_0.tcl
