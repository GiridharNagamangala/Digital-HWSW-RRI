...
HD_PWD='D:/GitHub/Digital-HWSW-RRI/SingleToneFFT/SingleToneFFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_singletoneFFT_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_singletoneFFT_wrapper.tcl
