...
HD_PWD='D:/GitHub/Digital-HWSW-RRI/SingleToneFFT/SingleToneFFT.runs/design_singletoneFFT_mult_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_singletoneFFT_mult_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_singletoneFFT_mult_gen_0_1.tcl
