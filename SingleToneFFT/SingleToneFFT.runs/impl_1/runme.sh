...
HD_PWD='D:/GitHub/Digital-HWSW-RRI/SingleToneFFT/SingleToneFFT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_singletoneFFT_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_singletoneFFT_wrapper.tcl -notrace
