...
#                script (type 'design_singletoneFFT.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/GitHub/Digital-HWSW-RRI/SingleToneFFT/SingleToneFFT.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
