...
#
# Script generated by Vivado on Wed Jul 09 11:09:35 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_singletoneFFT.sh
...
#
# Usage        : design_singletoneFFT.sh
#                design_singletoneFFT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_singletoneFFT.sh [-reset_run]
#                design_singletoneFFT.sh [-reset_log]
#                design_singletoneFFT.sh [-help]
#
...
# script info
echo -e "design_singletoneFFT.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_singletoneFFT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_singletoneFFT.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_singletoneFFT.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_singletoneFFT.sh [-help]\n\
Usage: design_singletoneFFT.sh [-step]\n\
Usage: design_singletoneFFT.sh [-lib_map_path]\n\
Usage: design_singletoneFFT.sh [-reset_run]\n\
Usage: design_singletoneFFT.sh [-reset_log]\n\
Usage: design_singletoneFFT.sh [-keep_index]\n\
Usage: design_singletoneFFT.sh [-noclean_files]\n\n\
