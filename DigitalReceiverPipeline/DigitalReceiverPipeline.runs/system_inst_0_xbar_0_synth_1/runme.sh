...
HD_PWD='D:/GitHub/Digital-HWSW-RRI/DigitalReceiverPipeline/DigitalReceiverPipeline.runs/system_inst_0_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_inst_0_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_inst_0_xbar_0.tcl
