...
-- Date        : Wed Jul  9 15:53:44 2025
-- Host        : GiridharKING running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/GitHub/Digital-HWSW-RRI/DigitalReceiverPipeline/DigitalReceiverPipeline.gen/sources_1/bd/design_pipeline/bd/system_inst_0/ip/system_inst_0_util_ds_buf_2_0/system_inst_0_util_ds_buf_2_0_sim_netlist.vhdl
-- Design      : system_inst_0_util_ds_buf_2_0
...
entity system_inst_0_util_ds_buf_2_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "OBUFDS";
  attribute C_MODE : string;
  attribute C_MODE of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "PERFORMANCE";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is 2;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_inst_0_util_ds_buf_2_0_util_ds_buf : entity is "util_ds_buf";
end system_inst_0_util_ds_buf_2_0_util_ds_buf;

architecture STRUCTURE of system_inst_0_util_ds_buf_2_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_inst_0_util_ds_buf_2_0 is
  port (
    OBUF_IN : in STD_LOGIC_VECTOR ( 1 downto 0 );
    OBUF_DS_P : out STD_LOGIC_VECTOR ( 1 downto 0 );
    OBUF_DS_N : out STD_LOGIC_VECTOR ( 1 downto 0 )
  ...
  attribute NotValidForBitStream of system_inst_0_util_ds_buf_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_inst_0_util_ds_buf_2_0 : entity is "system_inst_0_util_ds_buf_2_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_inst_0_util_ds_buf_2_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_inst_0_util_ds_buf_2_0 : entity is "util_ds_buf,Vivado 2024.2";
end system_inst_0_util_ds_buf_2_0;

architecture STRUCTURE of system_inst_0_util_ds_buf_2_0 is
  ...
  attribute x_interface_parameter of OBUF_IN : signal is "XIL_INTERFACENAME OBUF_IN, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_inst_0_util_ds_buf_1_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.system_inst_0_util_ds_buf_2_0_util_ds_buf
     port map (
