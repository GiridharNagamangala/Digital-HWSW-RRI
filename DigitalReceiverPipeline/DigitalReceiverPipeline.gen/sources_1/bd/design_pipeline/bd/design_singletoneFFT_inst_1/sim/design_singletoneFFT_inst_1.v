...
//Date        : Wed Jul  9 15:44:00 2025
//Host        : GiridharKING running 64-bit major release  (build 9200)
//Command     : generate_target design_singletoneFFT_inst_1.bd
//Design      : design_singletoneFFT_inst_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_singletoneFFT_inst_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_singletoneFFT_inst_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=23,numReposBlks=22,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=D_/GitHub/Digital-HWSW-RRI/SingleToneFFT/SingleToneFFT.srcs/sources_1/bd/design_singletoneFFT/design_singletoneFFT.bd,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_singletoneFFT_inst_1.hwdef" *) 
module design_singletoneFFT_inst_1
   (BRAM_PORTB_0_addr,
    ...
    mag_out,
    s_axis_data_tdata);
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB_0 ADDR" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTB_0, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 8192, MEM_WIDTH 64, READ_LATENCY 1, READ_WRITE_MODE READ_WRITE" *) input [12:0]BRAM_PORTB_0_addr;
  ...
  input SCLR_RSTx;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_RESET SCLR_RSTx, CLK_DOMAIN system_inst_0_axis_red_pitaya_adc_0_0_adc_clk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk_0;
  output [63:0]doutb;
  ...
  design_singletoneFFT_inst_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(Q),
  ...
  design_singletoneFFT_inst_1_blk_mem_gen_1_0 blk_mem_gen_1
       (.addra(xlconcat_0_dout),
        .addrb({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,BRAM_PORTB_0_addr}),
        .clka(aclk_0),
        ...
        .web(BRAM_PORTB_0_we));
  design_singletoneFFT_inst_1_c_addsub_0_1 c_addsub_0
       (.A(mag_out),
        .B(mux_acc_0_val_out),
        .CE(inputs_dout),
        .CLK(aclk_0),
        .S(S),
        .SCLR(SCLR_RSTx));
  design_singletoneFFT_inst_1_c_counter_binary_0_0 c_counter_binary_0
       (.CE(inputs_dout),
        .CLK(aclk_0),
        .Q(Q),
        .SCLR(xfft_0_m_axis_data_tlast));
  design_singletoneFFT_inst_1_latch_0_0 latch_0
       (.sig_in(signal_delay_0_dout),
        .sig_out(latch_start));
  mag_fft_imp_1KZFFAA mag_fft
       (.Din(xfft_0_m_axis_data_tdata),
        .aclk_0(aclk_0),
        .mag_out(mag_out));
  design_singletoneFFT_inst_1_mux_acc_0_0 mux_acc_0
       (.clk(aclk_0),
        .sel(latch_start),
        .val_in(doutb),
        .val_out(mux_acc_0_val_out));
  design_singletoneFFT_inst_1_signal_delay_0_0 signal_delay_0
       (.clk(aclk_0),
        .din(xfft_0_m_axis_data_tlast),
        .dout(signal_delay_0_dout),
        .rst(SCLR_RSTx));
  design_singletoneFFT_inst_1_signal_delay_1_0 signal_delay_1
       (.clk(aclk_0),
        .din(Q),
        .dout(signal_delay_1_dout),
        .rst(SCLR_RSTx));
  design_singletoneFFT_inst_1_xfft_0_0 xfft_0
       (.aclk(aclk_0),
  ...
  design_singletoneFFT_inst_1_xlconcat_0_0 xlconcat_0
       (.In0(signal_delay_1_dout),
        .In1(xlconstant_2_dout),
        .dout(xlconcat_0_dout));
  design_singletoneFFT_inst_1_xlconstant_0_0 xlconstant_0
       (.dout(inputs_dout_1));
  design_singletoneFFT_inst_1_xlconstant_1_0 xlconstant_1
       (.dout(inputs_dout));
  design_singletoneFFT_inst_1_xlconstant_2_0 xlconstant_2
       (.dout(xlconstant_2_dout));
  design_singletoneFFT_inst_1_xlconstant_3_0 xlconstant_3
       (.dout(xlconstant_3_dout));
  design_singletoneFFT_inst_1_xlconstant_4_0 xlconstant_4
       (.dout(CommandLogic_bram_wea));
  design_singletoneFFT_inst_1_xlslice_0_1 xlslice_0
       (.Din(xlconstant_3_dout),
        .Dout(xlslice_0_Dout));
  design_singletoneFFT_inst_1_xlslice_1_1 xlslice_1
       (.Din(xlconstant_2_dout),
        .Dout(xlslice_1_Dout));
endmodule

module mag_fft_imp_1KZFFAA
   (Din,
    aclk_0,
    mag_out);
  input [63:0]Din;
  ...
  design_singletoneFFT_inst_1_c_addsub_0_0 c_addsub_0
       (.A(mult_gen_0_P),
        .B(mult_gen_1_P),
        .CLK(aclk_0),
        .S(mag_out));
  design_singletoneFFT_inst_1_mult_gen_0_0 mult_gen_0
       (.A(xlslice_0_Dout),
        .B(xlslice_0_Dout),
        .CLK(aclk_0),
        .P(mult_gen_0_P));
  design_singletoneFFT_inst_1_mult_gen_1_0 mult_gen_1
       (.A(xlslice_1_Dout),
        .B(xlslice_1_Dout),
        .CLK(aclk_0),
        .P(mult_gen_1_P));
  design_singletoneFFT_inst_1_xlslice_0_0 xlslice_0
       (.Din(Din),
        .Dout(xlslice_0_Dout));
  design_singletoneFFT_inst_1_xlslice_1_0 xlslice_1
       (.Din(Din),
        .Dout(xlslice_1_Dout));
endmodule
