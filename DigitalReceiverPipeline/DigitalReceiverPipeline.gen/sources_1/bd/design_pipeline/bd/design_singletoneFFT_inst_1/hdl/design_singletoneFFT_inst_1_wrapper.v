...
//Command     : generate_target design_singletoneFFT_inst_1_wrapper.bd
//Design      : design_singletoneFFT_inst_1_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_singletoneFFT_inst_1_wrapper
   (BRAM_PORTB_0_addr,
    BRAM_PORTB_0_clk,
    BRAM_PORTB_0_din,
    BRAM_PORTB_0_dout,
  ...
  design_singletoneFFT_inst_1 design_singletoneFFT_inst_1_i
